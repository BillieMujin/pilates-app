  ...
  return (
    <div className="max-w-5xl mx-auto px-5 sm:px-8 py-8 sm:py-10">
      ...
      <div data-filter-bar className="sticky top-16 z-40 bg-background/90 backdrop-blur-xl -mx-5 sm:-mx-8 px-5 sm:px-8 pt-5 pb-4 mb-8">
        ...
        {user && (
          <Link href="/clients" className="flex items-center gap-2 mb-4 text-[13px] font-medium text-primary/70 hover:text-primary transition-colors px-3 py-2 rounded-xl border border-primary/10 hover:border-primary/20 hover:bg-primary/[0.03] w-fit">
